              ...
              <div className="shane-about-grid">
                ...
                <div className="shane-about-text">
                  ...
                  <div className="shane-stats">
                    <div className="shane-stat"><strong>10+</strong>專業造型師年資</div>
                    <div className="shane-stat"><strong>1000+</strong>滿意顧客體驗</div>
                    <div className="shane-stat"><strong>國際品牌</strong>沙龍級產品</div>
                    <div className="shane-stat"><strong>舒適環境</strong>放鬆美髮空間</div>
                  </div>
                </div>
              </div>
            </div>
